...
export default {
    ...
    data() {
        return {
            items: [
              {index: 0, title: '非遗文化', link: '#/overview/jianzhi',desc: '作为中阳非遗文化的代表，中阳剪纸与当地传统民俗文化血肉相连。它以中阳当地民俗信仰、岁时节令、人生礼仪、神话传说为主要表现内容，多以红纸剪成，体现着喜庆、热烈的民俗气氛。中阳剪纸作为第一批国家级非遗以及世界遗产，近年来受到政府广泛重视，以传承人武小汾为代表的的中阳剪纸正在蓬勃发展并带动当地就业。中阳县的非遗项目还有中阳刺绣、九曲灯会、中阳弹唱等。', pic: paper},
              {index: 1, title: '窑洞', link: '#/overview/yaodong',desc: '在阳坡村，仍然可以见到存在已久的土窑洞。窑洞是山西省的传统民居之一，一般修在朝南的山坡上，向阳，背靠山，面朝开阔地带，少有树木遮挡，十分适宜居住生活。窑洞沉积了古老的黄土地深层文化，广大人民在劳动中创造了窑洞艺术，小小窑洞浓缩了黄土地的别样风情。在旧窑洞的不远处便是新建的现代化建筑，值得一提的是，即使是现代化的建筑，依然是傍山而建，门窗拱形。可以说，窑洞在当地人民的心里有着举足轻重的地位。', pic: building},
              {index: 2, title: '移风易俗', link: '#/overview/yfys',desc: '无论是县城还是村镇，总能见到这样的标语——“婚事新办、丧事简办、余事不办”。近年来中阳政府在持续巩固提升脱贫攻坚成果的同时，将乡村振兴与文明建设进行有效衔接，大力宣传婚事新办、丧事简办、余事不办的良好社会风气，全面促进移风易俗工作制度化、规范化、常态化，乡村社会文明程度不断提升，摒弃陈规陋习、共建文明风尚的氛围日益浓厚。', pic: countryside},
              {index: 3, title: '美食', link: '#/overview/meishi',desc: '中阳县城的大街小巷，充满了各种经营当地美食的饭馆。柏籽羊肉是山西省的名特产品之一，肉质密实，油色洁白，味含柏香，不腥不腻，因放养山林食柏籽、喝柏水而得名，产区局限在中阳侧柏山区范围内。麻豆腐是中阳县的另一道传统美食，是用豆腐皮包裹猪肉馅和各种蔬菜，再用麻油和辣椒油炸而成，口感酥脆，味道独特。莜面为当地面试的一大代表，泛指用莜面制成的各种面食，有面条状、卷筒状、短条状等多种吃法，各有风味。', pic: noodles},
            ],
