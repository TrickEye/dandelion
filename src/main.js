...
const routes = [
    ...
    { path: '/overview/iron', component: () => import('./overview/iron.vue') },
    { path: '/overview/tech', component: () => import('./overview/tech.vue') },
    { path: '/overview/jianzhi', component: () => import('./overview/jianzhi.vue') },
    { path: '/overview/meishi', component: () => import('./overview/meishi.vue') },
    { path: '/overview/yaodong', component: () => import('./overview/yaodong.vue') },
    { path: '/overview/yfys', component: () => import('./overview/yfys.vue') },
    { path: '/overview/history1', component: () => import('./overview/history1.vue') },
    { path: '/overview/history2', component: () => import('./overview/history2.vue') },
    { path: '/overview/history3', component: () => import('./overview/history3.vue') },
